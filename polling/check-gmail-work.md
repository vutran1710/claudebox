Poll Gmail (work account) for new/unread emails using Chrome browser automation and forward them to am-server.

## Prerequisites
- Switch to the **work** Chrome profile before starting.
  ...
  -d '[
    {
      ...
      "raw": {"from": "<sender_email>", "subject": "<email_subject>", "snippet": "<preview>", "labels": ["inbox", "unread"], "account": "work"},
...
- Tag all messages with `"account": "work"` in the raw field.
